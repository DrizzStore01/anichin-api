...
@app.route('/app')
def web_app():
    return render_template('index.html', template_folder='../app')

# --- 1. HOME ---
@app.route('/donghua/home/<page>')
def get_home(page):
...
# --- 2. SEARCH ---
@app.route('/donghua/search/<query>/<page>')
...
# --- 3. DETAIL ---
@app.route('/donghua/detail/<path:slug>')
def get_detail(slug):
...
@app.route('/donghua/episode/<path:slug>')
...
# --- 5. COMPLETED ---
@app.route('/donghua/completed/<page>')
...
# --- 7. RUMBLE EXTRACTOR (MULTI QUALITY) ---
@app.route('/donghua/extract/rumble')
def extract_rumble():
